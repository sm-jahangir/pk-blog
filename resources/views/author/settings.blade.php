                    ...
                    <div class="body">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="profile_with_icon_title">
                                ...
                                <form action="{{url('author/profile-update')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    {{ csrf_field() }}
                                    <div class="row clearfix">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <textarea name="about" id="about" cols="130" rows="5">{{Auth::user()->about}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="password_with_icon_title">
                                ...
                                <form action="{{url('author/update-password')}}" method="POST" class="form-horizontal">
                                    {{ csrf_field() }}
